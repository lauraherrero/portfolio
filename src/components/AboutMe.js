    ...
    <div>
        <div className="aboutme" id="aboutMe">
            ...
            <div className="aboutme__content">
                ...
                <p className="aboutme__content--text">Más adelante trabajando en Teleperformance fui consciente de que quería dar un giro a mi trayectoria profesional y convertirme en programadora, lo cual me llevó a formarme como programadora front-end especializándome en JavaScript (ES6) y la librería React. Además, durante mi formación, he trabajado aplicando metodologías ágiles dentro del marco de trabajo Scrum.</p> 
